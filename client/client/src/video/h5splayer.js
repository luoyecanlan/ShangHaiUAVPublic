function H5sPlayerWS(t) {
  this.sourceBuffer,
    ...
    (this.C = t.token),
    void 0 === this.W
      ? ((this.I = t.videodom), console.log(t.token, "use dom directly"))
      : ((this.I = document.getElementById(this.W)),
...
function H5sPlayerRTC(t) {
  this.i,
    ...
    (this.s = this.I),
    (this.O = null),
    (this.J = { optional: [{ DtlsSrtpKeyAgreement: !0 }] }),
    (this.N = {
...
function createRTCSessionDescription(t) {
  return (
    console.log("createRTCSessionDescription "), new RTCSessionDescription(t)
  );
}
...
function float32ToInt16(t) {
  for (l = t.length, buf = new Int16Array(l); l--; )
...
(H5sPlayerWS.prototype.G = function() {
  console.log("Try Reconnect...", this.v),
    !0 === this.v &&
      (console.log("Reconnect..."), this._(this.C), (this.v = !1)),
    console.log("Try Reconnect...", this.v);
}),
  (H5sPlayerWS.prototype.K = function(t) {
    ...
    try {
      "http:" == this.P.protocol &&
        (s =
          "undefined" != typeof MozWebSocket
            ? new MozWebSocket("ws://" + this.P.host + t)
            : new WebSocket("ws://" + this.P.host + t)),
        "https:" == this.P.protocol &&
          (console.log(this.P.host),
          (s =
            "undefined" != typeof MozWebSocket
              ? new MozWebSocket("wss://" + this.P.host + t)
              : new WebSocket("wss://" + this.P.host + t))),
        console.log(this.P.host);
    } catch (t) {
  ...
  (H5sPlayerWS.prototype.j = function() {
    try {
      let t = { cmd: "H5_KEEPALIVE", nSpeed: "1.0", nTime: "0" };
  ...
  (H5sPlayerWS.prototype.Z = function() {
    ...
    try {
      if (
        ...
        let t = this.sourceBuffer.buffered.end(0),
          s = t - this.s.currentTime;
        if (5 < s || s < 0)
          return (
            console.log("CheckSourceBuffer Close 2", s), void this.i.close()
          );
        if (t == this.u) {
          if ((this.S++, 3 < this.S))
            return (
              console.log("CheckSourceBuffer Close 3"), void this.i.close()
            );
        } else this.S = 0;
        this.u = t;
      }
  ...
  (H5sPlayerWS.prototype.pause = function() {
    try {
      let t = { cmd: "H5_PAUSE", nSpeed: "1.0", nTime: "0" };
      this.i.send(JSON.stringify(t));
    } catch (t) {
      console.log(t);
    }
  ...
  (H5sPlayerWS.prototype.resume = function() {
    try {
      let t = { cmd: "H5_RESUME", nSpeed: "1.0", nTime: "0" };
      this.i.send(JSON.stringify(t));
    } catch (t) {
      console.log(t);
    }
  ...
  (H5sPlayerRTC.prototype.ct = function() {
    ...
    let s = new RTCPeerConnection(this.g, this.J),
      e = this;
    return (
      (s.onicecandidate = function(t) {
        e.it.call(e, t);
      }),
      void 0 !== s.ht
        ? (s.ht = function(t) {
      ...
      (s.oniceconnectionstatechange = function(t) {
        console.log(
          "oniceconnectionstatechange  state: " + s.iceConnectionState
        );
      }),
      console.log(
  ...
  (H5sPlayerRTC.prototype.rt = function(t) {
    ...
    try {
      ...
      this.O.setRemoteDescription(createRTCSessionDescription(t)),
        this.O.createAnswer(this.N).then(
          function(t) {
            console.log("Create answer:" + JSON.stringify(t)),
              s.O.setLocalDescription(
                t,
                function() {
  ...
  (H5sPlayerRTC.prototype.q = function(t) {
    ...
    console.log("Get Message type ", s.type),
      "offer" === s.type &&
        (console.log("Process Message type ", s.type), this.rt(s)),
      "remoteice" === s.type &&
        (console.log("Process Message type ", s.type), this.lt(s));
  }),
  ...
  (H5sPlayerAudio.prototype.q = function(t) {
    for (
      let s = new Int16Array(t.data),
        e = s.length,
        i = this.D.createBuffer(1, e, 8e3),
        o = 0;
      o < 1;
      o++
    )
      for (let n = i.getChannelData(o), c = 0; c < e; c++)
        n[c] = s[c] / 16383.5;
    let h = this.D.createBufferSource();
  ...
  (H5sPlayerAudBack.prototype.at = function(t) {
    ...
    try {
      navigator.getUserMedia({ s: !1, ut: !0 }, this.dt.bind(this));
    } catch (t) {
  ...
  (H5sPlayerAudBack.prototype.ft = function(t) {
    let s = float32ToInt16(t.inputBuffer.getChannelData(0));
    this.i.send(s);
  }),
  (H5sPlayerAudBack.prototype.dt = function(t) {
    try {
      let s = this.D.createMediaStreamSource(t);
      console.log("sampleRate", this.D.sampleRate);
      let e = this.D.createScriptProcessor(256, 1, 1);
      s.connect(e),
