 ...
 * @returns {Promise<any>}
 */
export const refresh_access = (refreshToken) => ajax(`${api_url}/rf`, refreshToken, http_type.put);
//令牌管理
/**
 * 获取全部令牌
 * @returns {Promise<any>}
 ...
 * @returns {Promise<any>}
 */
export const request_current = () => ajax(`${api_url}`);
/**
 * 当前用户基本信息修改
 * @returns {Promise<any>}
 */
 ...
 * @returns {Promise<any>}
 */
export const update_current_pwd = (data) => ajax(`${api_url}/user/pwd`, data, http_type.post);
//设备管理
/**
 * 创建设备
 * @param data
 ...
 * @returns {Promise<any>}
 */
export const request_his_targets = ({ index, size, data }) => ajax(`${api_url}/his/target?index=${index}&size=${size}`, data, http_type.post);
