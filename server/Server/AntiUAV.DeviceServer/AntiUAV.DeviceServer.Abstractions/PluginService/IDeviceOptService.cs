...
namespace AntiUAV.DeviceServer.Abstractions.PluginService
{
    ...
    /// 设备操作服务接口
    /// </summary>
    public interface IDeviceOptService
    {
        ...
        /// <returns></returns>
        byte[] GetGuidanceBuff(GuidancePositionInfo position);
        ...
        /// <returns></returns>
        byte[] GetRectifyBuff(double az, double el);
        ...
        /// <returns></returns>
        byte[] GetPositionBuff(double lat, double lng, double alt);
        ...
        /// <param name="sw"></param>
        /// <returns></returns>
        byte[] GetMonitorBuff(string json, bool sw);
        ...
        /// <returns></returns>
        byte[] GetAttackBuff(string json, bool sw);
        ...
        /// <returns></returns>
        byte[] GetDeviceOpBuff(short operationItem, int speed, short operationCode);
