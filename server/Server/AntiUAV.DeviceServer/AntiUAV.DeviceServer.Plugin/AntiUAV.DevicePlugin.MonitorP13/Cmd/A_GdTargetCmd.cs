...
namespace AntiUAV.DevicePlugin.MonitorP13.Cmd
{
    public class A_GdTargetCmd : IPeerCmd
    {
        ...
        public List<GuidancePositionInfo> guidancePositionInfos = new List<GuidancePositionInfo>();
        ...
        public Task Invoke(IPeerContent content)
        {
            ...
            //double r=(random.NextDouble()-0.5)/5;
            //Console.WriteLine($"{gpi.TargetX},{i+ (random.NextDouble() - 0.5) / 5}");
            //_memory.GetTracks();
